...
function readDataSet(directory) {
    ...
    for (file in files) {
        ...
        var plantDict = {
            ...
            opt_min_rain: parseFloat(content['Rainfall (annual)'][0])|| -10000,
            opt_max_rain: parseFloat(content['Rainfall (annual)'][1])|| -10000,
            abs_min_rain: parseFloat(content['Rainfall (annual)'][2])|| -10000,
            abs_max_rain: parseFloat(content['Rainfall (annual)'][3])|| -10000,
            ...
            optimal_min_temp: parseInt(content["Temperat. requir."][0])|| -10000,
            optimal_max_temp: parseInt(content["Temperat. requir."][1])|| -10000,
            absolute_min_temp: parseInt(content["Temperat. requir."][2])|| -10000,
            absolute_max_temp: parseInt(content["Temperat. requir."][3])|| -10000,
